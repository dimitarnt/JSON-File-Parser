...
void JsonPairContainer::addJsonPair(const char* key, JsonNodeType type, std::ifstream& in) {
    addJsonPair(key, type, in , getSize());
}
...
void JsonPairContainer::addJsonPair(const char* key, const SharedPtr<JsonNode>& newJsonNode) {
    addJsonPair(key, newJsonNode, getSize());
}
...
void JsonPairContainer::addJsonPair(const char* key, SharedPtr<JsonNode>&& newJsonNode) {
    addJsonPair(key, std::move(newJsonNode), getSize());
}
...
void JsonPairContainer::addJsonPair(const char* key, JsonNodeType type, std::ifstream& in, size_t index) {
    JsonObjectFactory objectFactory;
    JsonArrayFactory arrayFactory;
    JsonValueFactory valueFactory;
    JsonStringFactory stringFactory;
    ...
    switch(type) {
        ...
        case JsonNodeType::JSON_OBJECT:
            _jsonPairs.pushAt(Pair<String, SharedPtr<JsonNode>>(String(key), objectFactory.create(in)), index);
            break;

        case JsonNodeType::JSON_ARRAY:
            _jsonPairs.pushAt(Pair<String, SharedPtr<JsonNode>>(String(key), arrayFactory.create(in)), index);
            break;

        case JsonNodeType::JSON_VALUE:
            _jsonPairs.pushAt(Pair<String, SharedPtr<JsonNode>>(String(key), valueFactory.create(in)), index);
            break;

        case JsonNodeType::JSON_STRING:
            _jsonPairs.pushAt(Pair<String, SharedPtr<JsonNode>>(String(key), stringFactory.create(in)), index);
            break;
    }
}
...
void JsonPairContainer::addJsonPair(const char* key, const SharedPtr<JsonNode>& newJsonNode, size_t index) {
    _jsonPairs.pushAt(Pair<String, SharedPtr<JsonNode>>(String(key), newJsonNode), index);
}
...
void JsonPairContainer::addJsonPair(const char* key, SharedPtr<JsonNode>&& newJsonNode, size_t index) {
    _jsonPairs.pushAt(Pair<String, SharedPtr<JsonNode>>(String(key), std::move(newJsonNode)), index);
}
...
void JsonPairContainer::addJsonStringPair(const char* key, const String& value) {
    addJsonStringPair(key, value, getSize());
}
...
void JsonPairContainer::addJsonStringPair(const char* key, String&& value) {
    addJsonStringPair(key, std::move(value), getSize());
}
...
void JsonPairContainer::addJsonStringPair(const char* key, const char* value) {
    addJsonStringPair(key, value, getSize());
}
...
void JsonPairContainer::addJsonStringPair(const char* key, const String& value, size_t index) {
    _jsonPairs.pushAt(Pair<String, SharedPtr<JsonNode>>(String(key), JsonStringFactory::create(value)), index);
}
...
void JsonPairContainer::addJsonStringPair(const char* key, String&& value, size_t index) {
    _jsonPairs.pushAt(Pair<String, SharedPtr<JsonNode>>(String(key), JsonStringFactory::create(std::move(value))), index);
}
...
void JsonPairContainer::addJsonStringPair(const char* key, const char* value, size_t index) {
    _jsonPairs.pushAt(Pair<String, SharedPtr<JsonNode>>(String(key), JsonStringFactory::create(value)), index);
}
